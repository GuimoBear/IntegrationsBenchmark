...
namespace IntegrationsBenchmark.Benchmarks
{
    ...
    public class FlatbufferGreedyDeserializationBenchmark : BenchmarkBase
    {
        ...
        public async Task<List<Flats.WeatherDataGreedy>> SendDuplexAsync()
        {
        ...
        public async Task<List<Flats.WeatherDataGreedy>> SendStreamAsync()
        {
        ...
        public async Task<List<Flats.WeatherDataGreedy>> SendAsync()
        {
